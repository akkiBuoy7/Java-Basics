...
public class CollectionFrameworkInterface {
    /*
add(Object)	->     This method is used to add an object to the collection.

addAll(Collection c)	->    This method adds all the elements in the given collection to this
collection.
...
retainAll(Collection c)	-> This method is used to retain only the elements in this collection that
...
toArray()  -> This method is used to return an array containing all of the elements in this
collection.
     */
}
